<?php if (!defined('THINK_PATH')) exit(); /*a:4:{s:114:"/media/luckywujl/data/www/admin/localhost_9004/wwwroot/public/../application/admin/view/sale/detailtemp/index.html";i:1616217489;s:97:"/media/luckywujl/data/www/admin/localhost_9004/wwwroot/application/admin/view/layout/default.html";i:1616119994;s:94:"/media/luckywujl/data/www/admin/localhost_9004/wwwroot/application/admin/view/common/meta.html";i:1616119994;s:96:"/media/luckywujl/data/www/admin/localhost_9004/wwwroot/application/admin/view/common/script.html";i:1616119994;}*/ ?>
<!DOCTYPE html>
...
<script type="text/javascript">
    ...
    <div class="form-group">
        ...
        <div class="col-xs-12 col-sm-2">
            <input id="c-order_code" readonly="readonly" class="form-control" name="row[order_code]" type="text" value="<?php echo htmlentities($row['order_code']); ?>">
        </div>
    ...
    <div class="form-group">
        ...
        <div class="col-xs-12 col-sm-1">
            <input id="c-order_number_total" readonly="readonly" class="form-control" name="row[order_number_total]" type="number" value="<?php echo htmlentities($row['order_number_total']); ?>">
        </div>
        
        <label class="control-label col-xs-12 col-sm-1"><?php echo __('Order_length_total'); ?>:</label>
        <div class="col-xs-12 col-sm-1">
            <input id="c-order_length_total" readonly="readonly" class="form-control" name="row[order_length_total]" type="number" value="<?php echo htmlentities($row['order_length_total']); ?>">
        </div>

        <label class="control-label col-xs-12 col-sm-1"><?php echo __('Order_area_total'); ?>:</label>
        <div class="col-xs-12 col-sm-2">
            <input id="c-order_area_total" readonly="readonly" class="form-control" name="row[order_area_total]" type="number" value="<?php echo htmlentities($row['order_area_total']); ?>">
        </div>

        
        <label class="control-label col-xs-12 col-sm-1"><?php echo __('Order_amount_total'); ?>:</label>
        <div class="col-xs-12 col-sm-2">
            <input id="c-order_amount_total" readonly="readonly" class="form-control" name="row[order_amount_total]" type="number" value="<?php echo htmlentities($row['order_amount_total']); ?>">
        </div>
    </div>
    <div class="form-group">
        <label class="control-label col-xs-12 col-sm-1"><?php echo __('Order_hole_total'); ?>:</label>
        <div class="col-xs-12 col-sm-1">
            <input id="c-order_hole_total" readonly="readonly" class="form-control" name="row[order_hole_total]" type="number" value="<?php echo htmlentities($row['order_hole_total']); ?>">
        </div>
        <label class="control-label col-xs-12 col-sm-1"><?php echo __('Order_hole_amount_total'); ?>:</label>
        <div class="col-xs-12 col-sm-1">
            <input id="c-order_hole_amount_total" readonly="readonly" class="form-control" name="row[order_hole_amount_total]" type="number" value="<?php echo htmlentities($row['order_hole_amount_total']); ?>">
        </div>
        <label class="control-label col-xs-12 col-sm-1"><?php echo __('Order_edging_amount_total'); ?>:</label>
        <div class="col-xs-12 col-sm-1">
            <input id="c-order_edging_amount_total" readonly="readonly" class="form-control" name="row[order_edging_amount_total]" type="number" value="<?php echo htmlentities($row['order_edging_amount_total']); ?>">
        </div>
        <label class="control-label col-xs-12 col-sm-1"><?php echo __('Order_urgent_amount_total'); ?>:</label>
        <div class="col-xs-12 col-sm-1">
            <input id="c-order_urgent_amount_total" readonly="readonly" class="form-control" name="row[order_urgent_amount_total]" type="number" value="<?php echo htmlentities($row['order_urgent_amount_total']); ?>">
        </div>
        <label class="control-label col-xs-12 col-sm-1"><?php echo __('Order_other_amount_total'); ?>:</label>
        <div class="col-xs-12 col-sm-1">
            <input id="c-order_other_amount_total" readonly="readonly" class="form-control" name="row[order_other_amount_total]" type="number" value="<?php echo htmlentities($row['order_other_amount_total']); ?>">
        </div>
        <label class="control-label col-xs-12 col-sm-1"><?php echo __('Order_total_amount_total'); ?>:</label>
        <div class="col-xs-12 col-sm-1">
            <input id="c-order_total_amount_total" readonly="readonly" class="form-control" name="row[order_total_amount_total]" type="number" value="<?php echo htmlentities($row['order_total_amount_total']); ?>">
        </div>
	 </div>
    <div class="form-group">
        <label class="control-label col-xs-12 col-sm-1"><?php echo __('Order_remark'); ?>:</label>
        <div class="col-xs-12 col-sm-5">
            <input id="c-order_remark" class="form-control" name="row[order_remark]" type="text" value="<?php echo htmlentities($row['order_remark']); ?>">
        </div>
    ...
    <div class="form-group">
       <label class="control-label col-xs-12 col-sm-1"></label>
        <div class="col-xs-12 col-sm-5">
            ...
            <button type="button" id="savedraft" disabled="true" class="btn btn-success btn-embossed btn-savedraft"><?php echo __('保存草稿'); ?></button>
            <button type="button" class="btn btn-info btn-printing  btn-embossed"><?php echo __('打印'); ?></button>
            <button type="button" id="saveverify" disabled="true" class="btn btn-success btn-embossed btn-verify"><?php echo __('保存审核'); ?></button>
