<?php if (!defined('THINK_PATH')) exit(); /*a:4:{s:114:"/media/luckywujl/data/www/admin/localhost_9004/wwwroot/public/../application/admin/view/sale/detailtemp/index.html";i:1616119994;s:97:"/media/luckywujl/data/www/admin/localhost_9004/wwwroot/application/admin/view/layout/default.html";i:1616119994;s:94:"/media/luckywujl/data/www/admin/localhost_9004/wwwroot/application/admin/view/common/meta.html";i:1616119994;s:96:"/media/luckywujl/data/www/admin/localhost_9004/wwwroot/application/admin/view/common/script.html";i:1616119994;}*/ ?>
<!DOCTYPE html>
    ...
    <div class="form-group">
       ...
       <label class="control-label col-xs-12 col-sm-1"></label>
        <div class="col-xs-12 col-sm-5">
            ...
            <button type="button" class="btn btn-success btn-embossed btn-verify"><?php echo __('保存审核'); ?></button>
