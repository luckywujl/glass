<?php if (!defined('THINK_PATH')) exit(); /*a:4:{s:95:"/home/www/admin/localhost_9004/wwwroot/public/../application/admin/view/sale/ordermain/add.html";i:1614957372;s:81:"/home/www/admin/localhost_9004/wwwroot/application/admin/view/layout/default.html";i:1611580234;s:78:"/home/www/admin/localhost_9004/wwwroot/application/admin/view/common/meta.html";i:1611580234;s:80:"/home/www/admin/localhost_9004/wwwroot/application/admin/view/common/script.html";i:1611580234;}*/ ?>
<!DOCTYPE html>
...
<script type="text/javascript">
    ...
    <div class="form-group">
        ...
        <div class="col-xs-12 col-sm-8">
            <input id="c-order_operator" class="form-control" name="row[order_operator]" type="text">
        </div>
    </div>
    <div class="form-group">
        <label class="control-label col-xs-12 col-sm-2"><?php echo __('Order_checker'); ?>:</label>
        <div class="col-xs-12 col-sm-8">
            <input id="c-order_checker" class="form-control" name="row[order_checker]" type="text">
        </div>
    </div>
    <div class="form-group">
        <label class="control-label col-xs-12 col-sm-2"><?php echo __('Order_dispatcher'); ?>:</label>
        <div class="col-xs-12 col-sm-8">
            <input id="c-order_dispatcher" class="form-control" name="row[order_dispatcher]" type="text">
        </div>
    </div>
    <div class="form-group">
