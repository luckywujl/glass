<?php if (!defined('THINK_PATH')) exit(); /*a:4:{s:112:"/media/luckywujl/data/www/admin/localhost_9004/wwwroot/public/../application/admin/view/sale/detailtemp/add.html";i:1616119994;s:97:"/media/luckywujl/data/www/admin/localhost_9004/wwwroot/application/admin/view/layout/default.html";i:1616119994;s:94:"/media/luckywujl/data/www/admin/localhost_9004/wwwroot/application/admin/view/common/meta.html";i:1616119994;s:96:"/media/luckywujl/data/www/admin/localhost_9004/wwwroot/application/admin/view/common/script.html";i:1616119994;}*/ ?>
<!DOCTYPE html>
...
<script type="text/javascript">
    ...
    <div class="form-group">
        ...
        <div class="col-xs-12 col-sm-2">
            <input id="c-detail_product_specs" data-rule="required" class="form-control selectpage" data-source="base/product/index" data-field="product_specs" data-primary-key="product_specs" name="row[detail_product_specs]" type="text">
        </div>
    ...
    <div class="form-group">
        ...
        <div class="col-xs-12 col-sm-2">
            <input id="c-detail_area" data-rule="required" readonly="readonly" data-rule="required" class="form-control" name="row[detail_area]" type="number">
        </div>
    
        <label class="control-label col-xs-12 col-sm-1"><?php echo __('Detail_length'); ?>:</label>
        <div class="col-xs-12 col-sm-2">
            <input id="c-detail_length" readonly="readonly" data-rule="required" class="form-control" name="row[detail_length]" type="number">
        </div>
