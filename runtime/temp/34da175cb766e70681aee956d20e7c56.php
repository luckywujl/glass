...
<script type="text/javascript">
    ...
    <div class="form-group row">
         <label class="control-label col-xs-12 col-sm-2"><?php echo __('相关文档'); ?>:</label>
         <div class="col-xs-12 col-sm-8">
               ...
               <li class="col-xs-3">
                   ...
                   <input type="text" name="row[detail_documents_info][<%=index%>]" class="form-control" placeholder="请输入文件描述" value="<%=value?value:''%>"/>
